...
openssl x509 -req -in request/proxy.csr -CA cert/root.crt -CAkey private/root-sk.pem -CAcreateserial \
    -out cert/proxy.crt -sha384 -extfile /etc/ssl/openssl.cnf -extensions v3_ca
